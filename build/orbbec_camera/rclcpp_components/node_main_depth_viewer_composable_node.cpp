...
#define NODE_MAIN_LOGGER_NAME "depth_viewer_composable_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libdepth_viewer_component.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<orbbec_camera::DepthViewer>";
