...
static const _Segmentation_type_support_symbol_names_t _Segmentation_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ultralytics_ros, msg, Segmentation)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ultralytics_ros, msg, Segmentation)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, ultralytics_ros, msg, Segmentation)() {
  return &::ultralytics_ros::msg::rosidl_typesupport_c::Segmentation_message_type_support_handle;
}
