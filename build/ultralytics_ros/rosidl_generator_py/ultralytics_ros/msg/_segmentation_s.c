...
bool ultralytics_ros__msg__segmentation__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ultralytics_ros.msg._segmentation.Segmentation", full_classname_dest, 46) == 0);
  }
  ultralytics_ros__msg__Segmentation * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of Segmentation */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ultralytics_ros.msg._segmentation");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Segmentation");
